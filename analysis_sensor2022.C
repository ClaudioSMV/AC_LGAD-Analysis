...
void analysis_sensor2022(TString relative_path_input = "./", TString sensor_name = ""){
    ...
    // // Sensor: EIC2p5CP
    else if (sensor_name=="EIC2p5CP"){
        for (int i=0; i<27; i++){
            x_range.push_back(24.0 + i*1.0); // {24.0, 25.0, 26.0, ..., 49.0, 50.0};
            x_range_REAL.push_back(24.0 + i*1.0); // {24.0, 25.0, 26.0, ..., 49.0, 50.0};
        }
